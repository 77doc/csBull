          ...
          <div class="grid-content bg-purple">
            <el-form ref="form" label-width="100px" label-position="right" :model="second" v-for="(second,index1) in item" :key="index1">
              <el-form-item :label="second.text">
                ...
                <el-button type='text' v-if="second.field == 'imgUrl'" style="position: absolute;margin-left: 10px;right: -75px;top:3px;" @click="lookPic(second.value)">图片预览</el-button>
