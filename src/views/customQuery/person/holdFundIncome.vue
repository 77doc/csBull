<template>
  <div class="holdFundIncome ov" style="padding:0 20px;">
    <div class="filterBox">
      <el-form :model="queryForm" label-width="180px" label-position="right">
        ...
        <div style="text-align: center;">
          <el-button type="primary" @click="_selectHoldFundIncome">立即查询</el-button>
...
export default {
  ...
  methods: {
    ...
    _selectHoldFundIncome() {
      ...
      selectHoldFundIncome(params).then(res => {
