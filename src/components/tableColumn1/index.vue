...
<template>
    <el-table
            ...
            <slot 
                slot="empty"
                v-if="newComer">
                <router-link style="color:#00a0e9;" to="/buyFund">未持有产品，去看看~</router-link>
                </slot>
        <!--选择-->
