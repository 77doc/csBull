...
export function queryCustomInfoList(params) {
    return request({
        url: '/user/userInvest/queryCustomInfoList',
        method: 'GET',
        params
    })
}

export function getAccountInfoByIdNo(params) {
    return request({
        url: '/user/userInvest/getAccountInfoByIdNo',
        method: 'GET',
        params
    })
}
...
export function bindUserInfo(params) {
    return request({
        url: '/user/userInvest/bindUserInfo',
        method: 'POST',
        params
    })
}
